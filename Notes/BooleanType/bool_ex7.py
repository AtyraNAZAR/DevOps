...
# user. Our goal is to print True when John can lose weight and print False otherwise


# There is 2 factors to loosing weight 1 is a movement second is calory intake.
...
# What is the logical operator be between the is_intake and is_active?
